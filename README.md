...
- [Задание 1 - Профиль социальной сети](./preview/social-profile/)
- [Задание 2 - Секция статистики](./preview/statistics/)
- [Задание 3 - Список друзей](./preview/friend-list/)
- [Задание 4 - История транзакций](./preview/transaction-history/)
